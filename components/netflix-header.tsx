...
export default function NetflixHeader() {
  ...
  return (
    <>
      <header
        className={`fixed top-0 w-full z-40 transition-colors duration-300 netflix-header ${isScrolled ? "bg-black" : "bg-gradient-to-b from-black/80 to-transparent"}`}
      >
                    ...
                    <div className="absolute right-0 mt-2 w-80 bg-black border border-gray-800 rounded-md shadow-lg z-50">
                      ...
                      <div className="max-h-80 overflow-y-auto">
                        {notifications.map((notification) => (
                          <div
                            key={notification.id}
                            className="p-4 border-b border-gray-800 hover:bg-gray-900 text-white"
                          >
                ...
                <DropdownMenuContent align="end" className="bg-black/90 border-gray-700 text-white">
                  {user ? (
                    <>
                      ...
                      <DropdownMenuItem className="hover:bg-gray-800">
                        <Link
                          href={user.isInstructor && user.instructorId ? `/instructor/` : "/instructor/signup"}
                          className="w-full"
                        >
                          강사 전환
                        </Link>

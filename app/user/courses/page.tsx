        ...
        <div className="flex flex-col md:flex-row gap-8">
          ...
          <div className="w-full md:w-64 shrink-0">
            <div className="bg-gray-900 p-4 rounded-lg border border-gray-800 sticky top-4">
              ...
              <Accordion type="multiple" defaultValue={["price", "level", "skills"]} className="space-y-2">
                <AccordionItem value="price" className="border-gray-800">
                  <AccordionTrigger className="py-2 text-gray-300 hover:text-white">가격</AccordionTrigger>
                  <AccordionContent>
                ...
                <AccordionItem value="skills" className="border-gray-800">
                  <AccordionTrigger className="py-2 text-gray-300 hover:text-white">기술 스택</AccordionTrigger>
                  <AccordionContent>
                    <div className="space-y-2">
                      <div className="flex items-center">
                      ...
                      <div className="flex items-center">
                        ...
                        <Label htmlFor="skill-javascript" className="ml-2 text-sm text-gray-300">
                          JavaScript
                        </Label>
                      </div>
                      <div className="flex items-center">
